...
//    private User userObj;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user == null) {
            startActivity(new Intent(HistoryActivity.this, GuestActivity.class));
            finish();
        } else {
            Gson gson = new Gson();
            User userObj = gson.fromJson(user, User.class);

            findViewById(R.id.hsProfileImage).setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            firestore.collection("history")
                    ...
                    .get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            ...
                            RecyclerView recyclerView = findViewById(R.id.hsHistoryList);
